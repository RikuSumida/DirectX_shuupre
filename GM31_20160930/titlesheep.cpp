...
//コンストラクタ
CTitleSheep::CTitleSheep(int Priority) :CScene3D(Priority)
{
	/*テクスチャへのポインタ*/
...
//生成
CTitleSheep* CTitleSheep::Create(void)
{
	//CBillbord *Billbord;
	Enemy = new CTitleSheep;
	Enemy->Init();
...
D3DXVECTOR3 CTitleSheep::GetVec(void)
{
	return m_Vec1;
}
bool CTitleSheep::GetUse(void)
{
	return m_Use;
}
/*******************************************************************************
...
void CTitleSheep::Update(void)
{
	...
	CTitle* game = (CTitle*)GetManager()->GetMode();
...
D3DXVECTOR3 CTitleSheep::Wander(D3DXVECTOR3 Pos)
{
